...
export default function PortfolioCard({
  ...
  return (
    <div className="portfolio-card flex cursor-pointer flex-col overflow-hidden rounded-3xl bg-neutral-700 transition-transform duration-300 ease-in hover:scale-[1.05]">
